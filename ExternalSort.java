...
public class ExternalSort {
    ...
    /**
     * the location in working memory where the outbuffer starts (also the size of the heap)
     */
    private static final int OUTBUFFER = 45056;
    /**
     * the location of the second buffer during merge phase
     */
    private static final int INBUF = 20480;
    /**
     * location of outbuffer during merge phase
     */
    private static final int OUTBUF_START = 40960;
    /**
     * size of outbuffer in merge phase
     */
    private static final int OUTBUF_SIZE = 8192;
    ...
    /**
     * currently tracked number of runs
     */
    ...
    public static void sort(String theFileName) throws IOException {
        ...
        numRuns = (int)Math.ceil((double)FILE_SIZE / OUTBUFFER);
    ...
    /**
     * 
     * clears temp file so we can retest without just appending to a the file of a previous test
     * 
     * @throws IOException
     */
